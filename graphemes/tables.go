...
// _ControlǀCRǀLF is a merged (denormalized) range table for perf and readability
var _ControlǀCRǀLF = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x0, 0x1f, 1},
		{0x7f, 0x9f, 1},
		{0xad, 0x61c, 1391},
...
// _ExtendǀZWJ is a merged (denormalized) range table for perf and readability
var _ExtendǀZWJ = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x300, 0x36f, 1},
		{0x483, 0x489, 1},
		{0x591, 0x5bd, 1},
...
// _LVTǀT is a merged (denormalized) range table for perf and readability
var _LVTǀT = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x11a8, 0x11ff, 1},
		{0xac01, 0xac1b, 1},
		{0xac1d, 0xac37, 1},
...
// _LVǀV is a merged (denormalized) range table for perf and readability
var _LVǀV = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x1160, 0x11a7, 1},
		{0xac00, 0xd788, 28},
		{0xd7b0, 0xd7c6, 1},
...
// _LǀVǀLVǀLVT is a merged (denormalized) range table for perf and readability
var _LǀVǀLVǀLVT = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x1100, 0x11a7, 1},
		{0xa960, 0xa97c, 1},
		{0xac00, 0xd7a3, 1},
...
// _VǀT is a merged (denormalized) range table for perf and readability
var _VǀT = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x1160, 0x11ff, 1},
		{0xd7b0, 0xd7c6, 1},
		{0xd7cb, 0xd7fb, 1},
