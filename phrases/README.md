An implementation of phrase boundaries from [Unicode text segmentation](https://unicode.org/reports/tr29/#phrase_Boundaries) (UAX 29), for Unicode version 15.0.0.
