...
var _mergedAHLetterExtendFormatZWJ = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x41, 0x5a, 1},
		{0x61, 0x7a, 1},
		{0xaa, 0xad, 3},
...
// a 'denormalized' range table for perf and readability
var _mergedAHLetterNumericKatakana = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x30, 0x39, 1},
		{0x41, 0x5a, 1},
		{0x61, 0x7a, 1},
...
// a 'denormalized' range table for perf and readability
var _mergedAHLetterNumericKatakanaExtendNumLet = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x30, 0x39, 1},
		{0x41, 0x5a, 1},
		{0x5f, 0x5f, 1},
...
// a 'denormalized' range table for perf and readability
var _mergedMidLetterMidNumLetQ = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x27, 0x2e, 7},
		{0x3a, 0x5f, 37},
		{0xb7, 0xb7, 1},
...
// a 'denormalized' range table for perf and readability
var _mergedMidNumMidNumLetQ = &unicode.RangeTable{
	R16: []unicode.Range16{
		{0x27, 0x2c, 5},
		{0x2e, 0x3b, 13},
		{0x5f, 0x5f, 1},
