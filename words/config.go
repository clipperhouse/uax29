...
// JoinMiddleChars specifies which characters (runes) should
...
func (c *Config) JoinMiddleChars(joiners string) *Config {
	if c.midJoiners == nil {
...
// JoinLeadingChars specifies which characters (runes) should
...
func (c *Config) JoinLeadingChars(leaders string) *Config {
